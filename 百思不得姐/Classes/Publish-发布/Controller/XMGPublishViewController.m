...
- (void)buttonClick:(UIButton *)button
{
    [self cancelWithCompletionBlock:^{
        if (button.tag == 2) {
            SHNPostViewController *postWord = [[SHNPostViewController alloc] init];
            
            SHNNavigationController *nav = [[SHNNavigationController alloc] initWithRootViewController:postWord];
